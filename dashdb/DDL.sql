...
DROP TABLE "DASH6851"."GENDER_INDICATOR_TMP";
CREATE TABLE "DASH6851"."GENDER_INDICATOR_TMP" (
		"INDICATOR_ID" INTEGER NOT NULL,
		"INDICATOR" VARCHAR(300 OCTETS), 
		"PRIMARY" VARCHAR(300 OCTETS), 
		"UOM" VARCHAR(100 OCTETS),
...
--<SRC TABLE NCD_SRC_METADATA_INDICATOR/>
...
--<STG TABLE NCD_STG_METADATA_INDICATOR/>
...
---------<World Bank>	
---------------------------------------	
--17636 rows in "DASH6851"."WB_STG_INDICATOR"
DROP TABLE "DASH6851"."WB_STG_INDICATOR";
CREATE TABLE "DASH6851"."WB_STG_INDICATOR" (
		"iso2" VARCHAR(3 OCTETS), 
		"country" VARCHAR(100 OCTETS),
		"year" SMALLINT, 
		"indicatorID" VARCHAR(25 OCTETS), 
		"value" NUMERIC(21,10)
);
...
CREATE TABLE "DASH6851"."INDICATOR_BY_YEAR" (
	...
	CREATE TABLE "DASH6851"."DIVISION_INDICATOR" (
		"SOURCE_ID" VARCHAR(30 OCTETS),
